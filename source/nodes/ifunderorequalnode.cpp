...
namespace HuwInterpreter {
    namespace Nodes {
        IfUnderOrEqualNode::IfUnderOrEqualNode(std::shared_ptr<HuwInterpreter::Passable> passable, std::shared_ptr<Tokens::Token> token, std::shared_ptr<Nodes::Node> left, std::shared_ptr<Nodes::Node> right)
        ...
        std::shared_ptr<Variables::Variable> IfUnderOrEqualNode::execute(std::shared_ptr<Variables::Scope> globalScope, std::shared_ptr<Variables::Scope> scope)
        {
            ...
            if (left != nullptr && right != nullptr)
            {
                ...
                return std::move(l->ifUnderOrEqual(r, token));
            }
