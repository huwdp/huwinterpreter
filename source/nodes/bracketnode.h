...
#ifndef BRACKETNODE_H
#define BRACKETNODE_H
...
namespace HuwInterpreter {
    namespace Nodes {
        ...
        public:
            BracketNode(std::shared_ptr<HuwInterpreter::Passable> passable, std::shared_ptr<Tokens::Token> token, std::shared_ptr<Nodes::Node> node);
            NodeType getType();
