...
namespace HuwInterpreter {
    namespace Nodes {
        ...
        public:
            IfNode(std::shared_ptr<Passable> passable, std::shared_ptr<Tokens::Token> token, std::shared_ptr<Nodes::Node> condition, std::shared_ptr<Nodes::Node> body, std::shared_ptr<Nodes::Node> elseNode);
            NodeType getType();
