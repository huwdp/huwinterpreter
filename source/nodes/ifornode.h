...
namespace HuwInterpreter {
    namespace Nodes {
        class IfOrNode : public Node
        {
        protected:
            std::shared_ptr<Nodes::Node> left;
            std::shared_ptr<Nodes::Node> right;
        public:
            IfOrNode(std::shared_ptr<HuwInterpreter::Passable> passable, std::shared_ptr<Tokens::Token> token, std::shared_ptr<Nodes::Node> left, std::shared_ptr<Nodes::Node> right);
            NodeType getType();
