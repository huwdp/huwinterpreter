...
namespace HuwInterpreter {
    namespace Variables {
        ...
        public:
            ...
            IntegerVariable(std::shared_ptr<Passable> passable, std::shared_ptr<Tokens::Token> token);
            IntegerVariable(std::shared_ptr<Passable> passable, long long value, std::shared_ptr<Tokens::Token> token);
            IntegerVariable(std::string name, long long value, std::shared_ptr<Tokens::Token> token);
