...
namespace HuwInterpreter {
    namespace Functions {
        ToUpper::ToUpper(std::shared_ptr<HuwInterpreter::Passable> passable)
            : Function(passable)
        {
            setName("toUpper");
        }

        std::shared_ptr<Variable> ToUpper::execute(std::shared_ptr<Tokens::Token> token, std::shared_ptr<Variables::Scope> globalScope,
