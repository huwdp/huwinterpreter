...
namespace HuwInterpreter {
    namespace Functions {
        HttpPutFunction::HttpPutFunction(std::shared_ptr<HuwInterpreter::Passable> passable)
            : Function(passable)
        {
            setName("httpPut");
        }

        std::shared_ptr<Variable> HttpPutFunction::execute(std::shared_ptr<Tokens::Token> token, std::shared_ptr<Variables::Scope> globalScope,
