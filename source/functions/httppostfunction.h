...
namespace HuwInterpreter {
    namespace Functions {
        class HttpPostFunction : public Function
        {
        public:
            HttpPostFunction(std::shared_ptr<HuwInterpreter::Passable> passable);
            virtual ~HttpPostFunction() {}
