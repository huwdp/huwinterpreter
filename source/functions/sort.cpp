...
namespace HuwInterpreter {
    namespace Functions {
        Sort::Sort(std::shared_ptr<HuwInterpreter::Passable> passable)
            : Function(passable)
        {
            setName("sort");
        }

        std::shared_ptr<Variable> Sort::execute(std::shared_ptr<Tokens::Token> token, std::shared_ptr<Variables::Scope> globalScope,
