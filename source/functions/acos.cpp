...
namespace HuwInterpreter {
    namespace Functions {
        Acos::Acos(std::shared_ptr<HuwInterpreter::Passable> passable)
            : Function(passable)
        {
            setName("acos");
        }

        std::shared_ptr<Variable> Acos::execute(std::shared_ptr<Tokens::Token> token, std::shared_ptr<Variables::Scope> globalScope,
