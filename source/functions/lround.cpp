...
namespace HuwInterpreter {
    namespace Functions {
        LRound::LRound(std::shared_ptr<HuwInterpreter::Passable> passable)
            : Function(passable)
        {
            setName("round");
        }

        std::shared_ptr<Variable> LRound::execute(std::shared_ptr<Tokens::Token> token, std::shared_ptr<Variables::Scope> globalScope,
