...
namespace HuwInterpreter {
    namespace Functions {
        Atan::Atan(std::shared_ptr<HuwInterpreter::Passable> passable)
            : Function(passable)
        {
            setName("atan");
        }

        std::shared_ptr<Variable> Atan::execute(std::shared_ptr<Tokens::Token> token, std::shared_ptr<Variables::Scope> globalScope,
