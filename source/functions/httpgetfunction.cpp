...
namespace HuwInterpreter {
    namespace Functions {
        HttpGetFunction::HttpGetFunction(std::shared_ptr<Passable> passable)
            : Function(passable)
        {
            setName("httpGet");
        }

        std::shared_ptr<Variable> HttpGetFunction::execute(std::shared_ptr<Tokens::Token> token, std::shared_ptr<Scope> globalScope,
