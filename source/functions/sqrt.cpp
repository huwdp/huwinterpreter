...
namespace HuwInterpreter {
    namespace Functions {
        Sqrt::Sqrt(std::shared_ptr<HuwInterpreter::Passable> passable)
            : Function(passable)
        {
            setName("sqrt");
        }

        std::shared_ptr<Variable> Sqrt::execute(std::shared_ptr<Tokens::Token> token, std::shared_ptr<Variables::Scope> globalScope,
