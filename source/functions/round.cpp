...
namespace HuwInterpreter {
    namespace Functions {
        Round::Round(std::shared_ptr<HuwInterpreter::Passable> passable)
            : Function(passable)
        {
            setName("round");
        }

        std::shared_ptr<Variable> Round::execute(std::shared_ptr<Tokens::Token> token, std::shared_ptr<Variables::Scope> globalScope,
