...
namespace HuwInterpreter {
    namespace Functions {
        TimeFunction::TimeFunction(std::shared_ptr<Passable> passable)
            : Function(passable)
        {
            setName("localTime");
        }

        std::shared_ptr<Variable> TimeFunction::execute(std::shared_ptr<Tokens::Token> token, std::shared_ptr<Scope> globalScope,
