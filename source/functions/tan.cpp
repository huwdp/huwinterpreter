...
namespace HuwInterpreter {
    namespace Functions {
        Tan::Tan(std::shared_ptr<HuwInterpreter::Passable> passable)
            : Function(passable)
        {
            setName("tan");
        }

        std::shared_ptr<Variable> Tan::execute(std::shared_ptr<Tokens::Token> token, std::shared_ptr<Variables::Scope> globalScope,
