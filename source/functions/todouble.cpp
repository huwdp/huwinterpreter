...
namespace HuwInterpreter {
    namespace Functions {
        ToDouble::ToDouble(std::shared_ptr<HuwInterpreter::Passable> passable)
            : Function(passable)
        {
            setName("toDouble");
        }

        std::shared_ptr<Variable> ToDouble::execute(std::shared_ptr<Tokens::Token> token, std::shared_ptr<Variables::Scope> globalScope,
