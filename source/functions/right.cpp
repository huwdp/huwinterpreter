...
namespace HuwInterpreter {
    namespace Functions {
        Right::Right(std::shared_ptr<HuwInterpreter::Passable> passable)
            : Function(passable)
        {
            setName("right");
        }

        std::shared_ptr<Variable> Right::execute(std::shared_ptr<Tokens::Token> token, std::shared_ptr<Variables::Scope> globalScope,
