...
namespace HuwInterpreter {
    namespace Functions {
        Weekday::Weekday(std::shared_ptr<HuwInterpreter::Passable> passable)
            : Function(passable)
        {
            setName("weekday");
        }

        std::shared_ptr<Variable> Weekday::execute(std::shared_ptr<Tokens::Token> token, std::shared_ptr<Variables::Scope> globalScope,
