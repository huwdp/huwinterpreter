...
namespace HuwInterpreter {
    namespace Functions {
        Year::Year(std::shared_ptr<HuwInterpreter::Passable> passable)
            : Function(passable)
        {
            setName("year");
        }

        std::shared_ptr<Variable> Year::execute(std::shared_ptr<Tokens::Token> token, std::shared_ptr<Variables::Scope> globalScope,
