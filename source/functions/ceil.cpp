...
namespace HuwInterpreter {
    namespace Functions {
        Ceil::Ceil(std::shared_ptr<HuwInterpreter::Passable> passable)
            : Function(passable)
        {
            setName("ceil");
        }

        std::shared_ptr<Variable> Ceil::execute(std::shared_ptr<Tokens::Token> token, std::shared_ptr<Variables::Scope> globalScope,
