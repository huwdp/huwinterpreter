...
namespace HuwInterpreter {
    namespace Functions {
        Max::Max(std::shared_ptr<HuwInterpreter::Passable> passable)
            : Function(passable)
        {
            setName("max");
        }

        std::shared_ptr<Variable> Max::execute(std::shared_ptr<Tokens::Token> token, std::shared_ptr<Variables::Scope> globalScope,
