...
namespace HuwInterpreter {
    namespace Functions {
        Not::Not(std::shared_ptr<HuwInterpreter::Passable> passable)
            : Function(passable)
        {
            setName("not");
        }

        std::shared_ptr<Variable> Not::execute(std::shared_ptr<Tokens::Token> token, std::shared_ptr<Variables::Scope> globalScope,
