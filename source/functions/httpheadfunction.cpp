...
namespace HuwInterpreter {
    namespace Functions {
        HttpHeadFunction::HttpHeadFunction(std::shared_ptr<Passable> passable)
            : Function(passable)
        {
            setName("httpHead");
        }

        std::shared_ptr<Variable> HttpHeadFunction::execute(std::shared_ptr<Tokens::Token> token, std::shared_ptr<Scope> globalScope,
