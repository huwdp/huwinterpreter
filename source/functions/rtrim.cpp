...
namespace HuwInterpreter {
    namespace Functions {
        RTrim::RTrim(std::shared_ptr<HuwInterpreter::Passable> passable)
            : Function(passable)
        {
            setName("rTrim");
        }

        std::shared_ptr<Variable> RTrim::execute(std::shared_ptr<Tokens::Token> token, std::shared_ptr<Variables::Scope> globalScope,
