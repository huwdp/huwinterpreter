...
namespace HuwInterpreter {
    namespace Functions {
        Floor::Floor(std::shared_ptr<HuwInterpreter::Passable> passable)
            : Function(passable)
        {
            setName("floor");
        }

        std::shared_ptr<Variable> Floor::execute(std::shared_ptr<Tokens::Token> token, std::shared_ptr<Variables::Scope> globalScope,
