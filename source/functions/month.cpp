...
namespace HuwInterpreter {
    namespace Functions {
        Month::Month(std::shared_ptr<HuwInterpreter::Passable> passable)
            : Function(passable)
        {
            setName("month");
        }

        std::shared_ptr<Variable> Month::execute(std::shared_ptr<Tokens::Token> token, std::shared_ptr<Variables::Scope> globalScope,
