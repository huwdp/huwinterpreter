...
namespace HuwInterpreter {
    namespace Functions {
        IsStringType::IsStringType(std::shared_ptr<HuwInterpreter::Passable> passable)
            : Function(passable)
        {
            setName("isStringType");
        }

        std::shared_ptr<Variable> IsStringType::execute(std::shared_ptr<Tokens::Token> token, std::shared_ptr<Variables::Scope> globalScope,
