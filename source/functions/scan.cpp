...
namespace HuwInterpreter {
    namespace Functions {
        Scan::Scan(std::shared_ptr<HuwInterpreter::Passable> passable)
            : Function(passable)
        {
            setName("scan");
        }

        std::shared_ptr<Variable> Scan::execute(std::shared_ptr<Tokens::Token> token, std::shared_ptr<Variables::Scope> globalScope,
