...
namespace HuwInterpreter {
    namespace Functions {
        IsDoubleType::IsDoubleType(std::shared_ptr<HuwInterpreter::Passable> passable)
            : Function(passable)
        {
            setName("isDoubleType");
        }

        std::shared_ptr<Variable> IsDoubleType::execute(std::shared_ptr<Tokens::Token> token, std::shared_ptr<Variables::Scope> globalScope,
