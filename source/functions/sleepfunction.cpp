...
namespace HuwInterpreter {
    namespace Functions {
        SleepFunction::SleepFunction(std::shared_ptr<Passable> passable)
            : Function(passable)
        {
            setName("sleep");
        }

        std::shared_ptr<Variable> SleepFunction::execute(std::shared_ptr<Tokens::Token> token, std::shared_ptr<Scope> globalScope,
