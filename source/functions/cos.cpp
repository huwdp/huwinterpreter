...
namespace HuwInterpreter {
    namespace Functions {
        Cos::Cos(std::shared_ptr<HuwInterpreter::Passable> passable)
            : Function(passable)
        {
            setName("cos");
        }

        std::shared_ptr<Variable> Cos::execute(std::shared_ptr<Tokens::Token> token, std::shared_ptr<Variables::Scope> globalScope,
