...
namespace HuwInterpreter {
    namespace Functions {
        Log::Log(std::shared_ptr<HuwInterpreter::Passable> passable)
            : Function(passable)
        {
            setName("log");
        }

        std::shared_ptr<Variable> Log::execute(std::shared_ptr<Tokens::Token> token, std::shared_ptr<Variables::Scope> globalScope,
