...
namespace HuwInterpreter {
    namespace Functions {
        Left::Left(std::shared_ptr<HuwInterpreter::Passable> passable)
            : Function(passable)
        {
            setName("left");
        }

        std::shared_ptr<Variable> Left::execute(std::shared_ptr<Tokens::Token> token, std::shared_ptr<Variables::Scope> globalScope,
