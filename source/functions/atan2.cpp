...
namespace HuwInterpreter {
    namespace Functions {
        Atan2::Atan2(std::shared_ptr<HuwInterpreter::Passable> passable)
            : Function(passable)
        {
            setName("atan2");
        }

        std::shared_ptr<Variable> Atan2::execute(std::shared_ptr<Tokens::Token> token, std::shared_ptr<Variables::Scope> globalScope,
