...
std::shared_ptr<Variable> IsDouble::run(std::shared_ptr<Token> token,
                                        ...
                                        std::vector<std::shared_ptr<Node>> variables)
{
    ...
    {
        Errors::add(std::make_shared<Error>(FUNCTION_ERROR, "isDouble function requires one arguments", token));
    }
    return returnNode;
}
