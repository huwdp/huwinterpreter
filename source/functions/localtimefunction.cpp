...
namespace HuwInterpreter {
    namespace Functions {
        LocalTimeFunction::LocalTimeFunction(std::shared_ptr<Passable> passable)
            : Function(passable)
        {
            setName("localTime");
        }

        std::shared_ptr<Variable> LocalTimeFunction::execute(std::shared_ptr<Tokens::Token> token, std::shared_ptr<Scope> globalScope,
